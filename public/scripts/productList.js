...
function renderCSV2(){
	...
	script.innerHTML = '"@type":"Dataset","@context":"https://schema.org/","name":"Product List","description":"List of products sold by Richmond Paper Supply","distribution":{"@type":"DataDownload","encodingFormat":"CSV","contentUrl":"https://www.richmondpapersupply.co.uk/productList.csv"}';
